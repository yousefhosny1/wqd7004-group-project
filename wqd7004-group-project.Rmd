...
author: "Yousef, Nur Iffahtul Najihah Anuar (17155569), Nadia Nadhirah Mahzan (S2107527), Nurul Shahirah Sha'ari (S2120876)"
date: '2022-06-13'
...
```
The correlation coefficient between actual and predicted value for both training and testing set is 0.934 and 0.935 respectively, suggests a strong positive correlation. The p value for the test is smaller than 0.05, thus, the null hypothesis is rejected. 
